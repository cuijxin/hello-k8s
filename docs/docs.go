...
var doc = `{
    ...
    "paths": {
        ...
        "/v1/helm/namespaces/{namespace}/releases/{release}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "release参数",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/releases.ReleaseOptions"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/helm/namespaces/{namespace}/releases/{release}/histories": {
            "get": {
        ...
        "/v1/helm/namespaces/{namespace}/releases/{release}/status": {
            "get": {
        ...
        "/v1/helm/namespaces/{namespace}/releases/{release}/versions/{reversion}": {
            "put": {
