...
func CreateCluster(c *gin.Context) {
	...
	if err != nil {
		tool.SendResponse(c, errno.ErrCreatePgsqlClientSet, nil)
	}
	...
	if err != nil {
		tool.SendResponse(c, errno.ErrCreatePostgresCluster, err)
		return
	}
...
func DeleteCluster(c *gin.Context) {
	...
	if err != nil {
		tool.SendResponse(c, errno.ErrDeletePostgresCluster, err)
		return
	}
...
func GetCluster(c *gin.Context) {
	...
	if err != nil {
		tool.SendResponse(c, errno.ErrGetPostgresCluster, err)
		return
	}
...
func GetClusterList(c *gin.Context) {
	...
	if err != nil {
		tool.SendResponse(c, errno.ErrGetPostgresClusterList, err)
		return
	}
