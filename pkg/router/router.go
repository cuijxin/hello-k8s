...
import (
	_ "hello-k8s/docs"
	"hello-k8s/pkg/handler/atomapp/atomservice"
	"hello-k8s/pkg/handler/atomapp/buildimage"
	"hello-k8s/pkg/handler/atomapp/clonecode"
	"hello-k8s/pkg/handler/operator/mysql"
	"hello-k8s/pkg/handler/operator/pgsql"
	"hello-k8s/pkg/handler/operator/redis"
	"hello-k8s/pkg/handler/resources/configmap"
	"hello-k8s/pkg/handler/resources/container"
	"hello-k8s/pkg/handler/resources/cronjob"
	"hello-k8s/pkg/handler/resources/deployment"
	"hello-k8s/pkg/handler/resources/job"
	"hello-k8s/pkg/handler/resources/persistentvolumeclaim"
	"hello-k8s/pkg/handler/resources/pod"
	"hello-k8s/pkg/handler/resources/secret"
	"hello-k8s/pkg/handler/resources/service"
	"hello-k8s/pkg/handler/resources/storageclass"
	"hello-k8s/pkg/handler/sd"
