...
import (
	...
	crdv1 "hello-k8s/pkg/kubernetes/kuberesource/resource/customresourcedefinition/v1"
	crdv1beta1 "hello-k8s/pkg/kubernetes/kuberesource/resource/customresourcedefinition/v1beta1"
