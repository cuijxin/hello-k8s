...
import (
	...
	"hello-k8s/pkg/kubernetes/kuberesource/plugin/apis/v1alpha1"

	authApi "hello-k8s/pkg/kubernetes/kuberesource/auth/api"
	clientapi "hello-k8s/pkg/kubernetes/kuberesource/client/api"
	"hello-k8s/pkg/kubernetes/kuberesource/plugin/client/clientset/versioned"
	fakePluginClientset "hello-k8s/pkg/kubernetes/kuberesource/plugin/client/clientset/versioned/fake"
