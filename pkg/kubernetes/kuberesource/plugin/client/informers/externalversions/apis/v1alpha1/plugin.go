...
import (
	...
	apisv1alpha1 "hello-k8s/pkg/kubernetes/kuberesource/plugin/apis/v1alpha1"
	versioned "hello-k8s/pkg/kubernetes/kuberesource/plugin/client/clientset/versioned"
	internalinterfaces "hello-k8s/pkg/kubernetes/kuberesource/plugin/client/informers/externalversions/internalinterfaces"
	v1alpha1 "hello-k8s/pkg/kubernetes/kuberesource/plugin/client/listers/apis/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DashboardV1alpha1().Plugins(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DashboardV1alpha1().Plugins(namespace).Watch(options)
			},
		},
		&apisv1alpha1.Plugin{},
		resyncPeriod,
